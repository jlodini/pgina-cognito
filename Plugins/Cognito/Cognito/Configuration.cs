...
namespace pGina.Plugin.Cognito
{
    public partial class Configuration : Form
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(this.Loginserver_textBox, "Cognito endpoint");
        }
        ...
        public bool UiToSettings()
        {
            ...
            {
                MessageBox.Show(this, "Cognito endpoint is empty", "Loginserver", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
